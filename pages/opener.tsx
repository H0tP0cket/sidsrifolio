    ...
    <>
      <main className=" md:w- flex w-full max-w-8xl flex-1   flex-col  pr-56 pt-24 md:static  ">
        ...
        <div className="pt-4 pl-20 md:pl-56">
          <button className=" animate__animated animate__fadeInLeft animate__delay-3s halal flex w-48 border border-pink-800 bg-transparent py-4 px-4 font-cool  text-3xl  font-bold italic text-pink-800 hover:border-transparent md:w-96">
            Reach Out
          </button>
        </div>
      </main>
